...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('click', function(e) {
    ...
    if (isRTL) {
      const scrollLeft = target.getBoundingClientRect().left + window.pageXOffset - (window.innerWidth - document.documentElement.clientWidth);
      window.scrollTo({
        left: scrollLeft,
        behavior: 'smooth'
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '87340fe6-2d70-453c-a845-69457e48b435',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '87340fe6-2d70-453c-a845-69457e48b435';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '87340fe6-2d70-453c-a845-69457e48b435';
